    ...
    <div className="pb-[140px]">
        <Container>
            ...
            <Flex className={'pb-[70px] gap-x-7'}>
                <Input type={'password'} placeholder={'Password'} title={'Password'} inputclass={" py-4"} />
                <Input type={'password'} placeholder={'Repeat Password'} title={'Repeat Password'} inputclass={" py-4"} />
            </Flex>
            <hr className="border-[#F0F0F0] pb-[65px] "  />
           <Flex className={'gap-x-4 pb-6'}>
            <Input divclassName={"w-4"} type={"checkbox" } inputclass={" py-4"} />
